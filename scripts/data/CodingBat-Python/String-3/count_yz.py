"""
CodingBat > Python > String-3 > countYZ
...
sensitive). We'll say that a y or z is at the end of a word if there is not an
alphabetic letter immediately following it. (Note: Character.isLetter(char)
